...
function starter_scripts() {
	...
	wp_enqueue_script( 'starter-my', get_template_directory_uri() .'/assets/js/custom.js');
	...
	// css
	wp_enqueue_style( 'starter-normalize', get_template_directory_uri() . '/assets/css/normalize.css' );
	wp_enqueue_style( 'starter-skeleton', get_template_directory_uri() . '/assets/css/skeleton.css');
	wp_enqueue_style( 'starter-my', get_template_directory_uri() . '/assets/css/my.css');
}
